...
/**
 * Handle the appstack release workflow tool requests
 * 
...
export async function handleAppStackReleaseWorkflowTools(request: any) {
  switch (request.params.name) {
    case 'list_system_all_release_workflows':
    ...
    case 'create_system_release_workflows':
